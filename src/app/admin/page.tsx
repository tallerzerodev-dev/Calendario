      ...
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-10">
        ...
        <section className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
          ...
          <div className="flex flex-col gap-6">
            <div className="rounded-3xl border border-gray-200 bg-gray-50/70 p-6 shadow-sm">
              ...
              >
                ...
                <button
                  type="submit"
                  className="rounded-full bg-black px-4 py-2 text-xs font-semibold uppercase tracking-[0.3em] text-white"
                >
                  Generar cupos
                </button>
              </form>
            ...
            <div className="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm">
              ...
              <div className="mt-4 space-y-3">
                {users.map((user) => (
                  ...
                  >
                    ...
                    <div className="text-xs text-gray-500">Créditos: {user.classCredits}</div>
              <form
                action={async (formData) => {
                  "use server";
                  await updateCredits({
              ...
              >
                <input
                  ...
                  className="w-24 rounded-xl border border-gray-300 bg-white px-3 py-1 text-sm"
                />
                <button
                  type="submit"
                  className="rounded-full border border-gray-300 px-3 py-1 text-xs font-semibold uppercase tracking-[0.3em] text-gray-600"
                >
                  Guardar
                </button>
              </form>
                ...
                {users.length === 0 && (
                  <p className="text-sm text-gray-500">Aún no hay usuarios registrados.</p>
                )}
              </div>
            </div>
          </div>
        ...
        <section className="rounded-3xl border border-gray-200 bg-gray-50/70 p-8 shadow-sm">
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-2">
            ...
            {upcomingSlots.length === 0 && (
              <p className="text-sm text-gray-500">No hay cupos disponibles aún.</p>
            )}
          </div>
        </section>
      </div>
